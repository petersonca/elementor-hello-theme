...
if ( ! function_exists( 'hello_elementor_setup' ) ) {
	function hello_elementor_setup() {
		...
		$hook_result = apply_filters_deprecated( 'elementor_hello_theme_register_sidebars', [ true ], '2.0', 'hello_elementor_register_sidebars' );
		if ( apply_filters( 'hello_elementor_register_sidebars', $hook_result ) ) {
